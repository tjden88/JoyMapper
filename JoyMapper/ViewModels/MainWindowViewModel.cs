...
public partial class MainWindowViewModel : WindowViewModel
{
    ...
    public AudioPlayerControlsViewModel AudioPlayerControlsViewModel { get; }
    ...
    public MainWindowViewModel(DataManager DataManager, AppUpdateService AppUpdateService , IProfileListener ProfileListener, AppWindowsService AppWindowsService, AudioPlayerViewModel audioPlayerViewModel, AudioPlayerControlsViewModel audioPlayerControlsViewModel)
    {
        AudioPlayerViewModel = audioPlayerViewModel;
        AudioPlayerControlsViewModel = audioPlayerControlsViewModel;
